...
def ensure_requirements_in_extra_files(construct_data: dict):
    ...
    if Path("requirements-linux.txt").exists():
        ...
        if not linux_included:
            extra_files.append({"requirements-linux.txt": "LabConstrictor_Demo/requirements-linux.txt"})
    ...
    if Path("requirements-windows.txt").exists():
        ...
        if not windows_included:
            extra_files.append({"requirements-windows.txt": "LabConstrictor_Demo/requirements-windows.txt"})
    ...
    if Path("requirements-macos.txt").exists():
        ...
        if not macos_included:
            extra_files.append({"requirements-macos.txt": "LabConstrictor_Demo/requirements-macos.txt"})
